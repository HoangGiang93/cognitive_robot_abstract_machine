...
class TestUtilsModuleLoader(object):
    ...
    def test_load_ae_invalid_input(self, module_loader: ModuleLoader, pkg_name: str, module_name: str):
    ...
    @pytest.mark.parametrize(["pkg_name", "module_name"], invalid_modules)
    def test_load_annotator_invalid_input(self, module_loader: ModuleLoader, pkg_name: str, module_name: str):
        assert pytest.raises(ImportError, module_loader.load_annotator, pkg_name, module_name)
    ...
    @pytest.mark.parametrize(["pkg_name", "module_name"], invalid_modules)
    def test_load_camera_config_invalid_input(self, module_loader: ModuleLoader, pkg_name: str, module_name: str):
        assert pytest.raises(ImportError, module_loader.load_camera_config, pkg_name, module_name)
    ...
    @pytest.mark.parametrize(["pkg_name", "module_name"], invalid_modules)
    def test_load_tree_components_invalid_input(self, module_loader: ModuleLoader, pkg_name: str, module_name: str):
        assert pytest.raises(ImportError, module_loader.load_tree_components, pkg_name, module_name)

    def test_load_types(self, module_loader: ModuleLoader):
        assert module_loader.load_types("robokudo", "annotation.py")

    @pytest.mark.parametrize(["pkg_name", "module_name"], invalid_modules)
    def test_load_types_invalid_input(self, module_loader: ModuleLoader, pkg_name: str, module_name: str):
        assert pytest.raises(ImportError, module_loader.load_types, pkg_name, module_name)

    def test_load_utils(self, module_loader: ModuleLoader):
        assert module_loader.load_utils("robokudo", "module_loader.py")

    @pytest.mark.parametrize(["pkg_name", "module_name"], invalid_modules)
    def test_load_utils_invalid_input(self, module_loader: ModuleLoader, pkg_name: str, module_name: str):
        assert pytest.raises(ImportError, module_loader.load_utils, pkg_name, module_name)
